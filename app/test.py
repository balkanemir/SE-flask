...
class TestAPIMethods(unittest.TestCase):
    def setUp(self):
        ...
        cmd = """
            CREATE TABLE users
            (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, surname TEXT, identity_number
            INTEGER)"""
        result = app.db.engine.execute(cmd)
    ...
    def test_post(self):
        ...
        expected = json.dumps({"name": "Peter", "surname": "Watson", "identity_number": 511247,
                            "links": [{"rel": "self", "resource": "http://127.0.0.1:8000/v1/users/2", "method":
                                "GET"},
                            {"rel": "update", "resource": "http://127.0.0.1:8000/v1/users/2", "method":
                            "PATCH"},
                            {"rel": "update", "resource": "http://127.0.0.1:8000/v1/users/2", "method":
